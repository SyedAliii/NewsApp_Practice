...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=84c35aca43a34f2a8412c203bb6ae774&page=${this.state.page}&pageSize=${this.props.pageSize}`;
